...
<meta name="description"
	content="In pede mi aliquet sit amet euismod in, auc ligula aliquam dapibus tincidunt beatae vi." />
<meta name="generator"
	content="Joomla! - Open Source Content Management" />
<title>Bienvenido a nuestro club</title>
	...
	jQuery(document)
			.ready(
					function($) {
						/*Image Preloader*/
						$(
								"span.catItemImage, span.itemImage, span.userItemImage, span.genericItemImage")
								.preloader({
...
<body class="cssstyle-style1 respmenu-type-sfmenu col16" id="all">
	...
	<div id="body-wrapper">
		...
		<div id="wrapper"
			class=" homepage view-itemlist option-com_k2 task-category">
