...
<head>
	...
	-->
	<meta charset="utf-8">
	<title>Inscripcion al Sorteo</title>
...
<body>
	<jsp:include page="/Club/generalClub/superior.jsp" />
		...
		<div class="row-fluid">
		 ...
		 return false;"> -->
		 <form class="form-horizontal" name="frmCriteriosBusqueda" id="frmCriteriosBusqueda"  method="post" action="<%= response.encodeURL("SMCSorteo")%>">
		 <input type="hidden" name="accion" value="Buscar"></input>
			...
			<form id="frmAlternativo" name="frmAlternativo" method="post" action="<%= response.encodeURL("SMCSorteo")%>">
			<input type="hidden" name="accion" value="Inscripcion"></input>
                          ...
                          <element>
                          	<tbody id="resultadoBusqueda">
                          		...
                          		<tr>
                          			<td class="center">
                          				<%=
                          					((ResultadoInscripcionSorteoBeanData)resultados.get(i)).getNombSede()
                          				%>
                          			</td>
                          			<td class="center">
                          				<%=
                          					((ResultadoInscripcionSorteoBeanData)resultados.get(i)).getNombre()
                          				%>
                          			</td>
                          			<td class="center">
                          				<%=
                          					df.format(((ResultadoInscripcionSorteoBeanData)resultados.get(i)).getFechaIni())
                          				%>
                          			</td>
                          			<td class="center">
                          				<%=
                          					df.format(((ResultadoInscripcionSorteoBeanData)resultados.get(i)).getFechaFin())                  
                          				%>
                          			</td>
                          			<td class="center">
                          				<%=
                          					df.format(((ResultadoInscripcionSorteoBeanData)resultados.get(i)).getFechaSorteo())                  
                          				%>
                          			</td>
                          			<td class="center">
                          				...
                          				<%}else{ %>
                          				<a class="btn btn-success" 
                          					href="javascript:alt_inscripcion('<%=((ResultadoInscripcionSorteoBeanData)resultados.get(i)).getCodigo()%>')">
                          					<i class="icon-zoom-in icon-white">
                          					</i>Inscripcion
                          				</a>
                          				<%} %>
