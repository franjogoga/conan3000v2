		...
		<div class="row-fluid">
		  ...
		  <noscript>
			...
			<div id="content" class="span10">
			  ...
			  <div>
			    <ul class="breadcrumb">
			      <li> <a href="#">Home</a> / Registrar Entrada o Salidad </li>
		        </ul>
		      </div>
			        ...
			        <form class="form-horizontal">
					  ...
					  <!--    ----------------------------------------------------------------------------------------------    -->
						    ...
						    <div class="control-group">
						      <label class="control-label" for="typeahead7">C�digo(*): </label>
						      <div class="controls">
						    ...
						    <div class="control-group">
						      <label class="control-label" for="typeahead7">Hora: </label>
						      <div class="controls">
