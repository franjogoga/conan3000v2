...
<body>
	<jsp:include page="/IngSoft/general/superior.jsp" />
		...
		<div class="row-fluid">
		 ...
		 <!--  paso 1  configuracion de link + variables -->													 <!-- nos linkea al archivo SMAReserva -->
		 <form class="form-horizontal" name="frmCriteriosBusqueda" id="frmCriteriosBusqueda"  method="post" action="<%= response.encodeURL("SMAReserva")%>">
		                                      <!-- Buscar  variable  que pasa al archivo SMAReserva   -->	
		 <input type="hidden" name="accion" value="Buscar"></input>
		  <input type="hidden" name="tipo" value="2"></input>
						  <fieldset>
							
							<div class="control-group">
							  <label class="control-label" for="typeahead">C&oacutedigo Invitado:</label>
							  <div class="controls">									   <!-- txtCodigoInvitado  variable     -->	
								<input type="text" class="span6 typeahead" id="txtCodigoInvitado" name="txtCodigoInvitado">
							  </div>
							</div>
		    ...
		    <!--  paso 3  configuracion de link + variables -->				  <!-- nos linkea al archivo SMAReserva -->
			<form id="frmAlternativo" name="frmAlternativo" method="post" action="agregarreserva.jsp">
                        ...
                        <table class="table table-striped table-bordered bootstrap-datatable datatable">
                          ...
                          <element>
                          	<tbody id="resultadoBusqueda">
                          		...
                          		<td class="center">
                          				<%=
                          					((ResultadoReservaBeanData)resultados.get(i)).getCodigo()
                          				%>
                          			</td class="center">
                          			<td>
                          				<%=
                          					((ResultadoReservaBeanData)resultados.get(i)).getCodigosocio()
                          				%>
                          			</td>
                          			<td>
                          				<%=
                          					((ResultadoReservaBeanData)resultados.get(i)).getCodigoinvitado()
                          				%>
                          			</td>
									<td >
                          				<%=
                          					df.format(((ResultadoReservaBeanData)resultados.get(i)).getFechainvitacion())
                          			...
                          			<td>
                          				<%=
                          					((ResultadoReservaBeanData)resultados.get(i)).getMonto()
                          				%>
                          			</td>
                          			...
                          			<td class="center">
								           ...
								           <%
												  ...
												  if( ((ResultadoReservaBeanData)resultados.get(i)).getEstado().equalsIgnoreCase("activo") ){    
								 out.print(" <span class='label label-success'> " + ((ResultadoReservaBeanData)resultados.get(i)).getEstado()   +"   </span>       ");
												  }
												  else { 
								 out.print(" <span class='label label-warning'> " + ((ResultadoReservaBeanData)resultados.get(i)).getEstado()   +"   </span>       ");
                          			...
                          			<td class="center">
                          				...
                          				<a class="btn btn-info"
                          					href="javascript:alt_modificar('<%=((ResultadoReservaBeanData)resultados.get(i)).getCodigo()%>')">
                          					<i
