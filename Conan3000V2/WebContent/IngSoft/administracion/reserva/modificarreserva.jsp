			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
					  <h2><i class="icon-edit"></i>MODIFICAR RESERVA</h2>
				  </div>
						...
						<input type="hidden" name="tipo" value="2"></input>
						  ...
						  <fieldset>
							...
							<div class="control-group" id="dvNombre" >
						      ...
						      <div class="controls">
						        <input type="text" class="span6 typeahead" id="txtNombre"  data-provide="typeahead"  name="txtNombre" value="<%= reserva.getNombres()%>">
						    ...
						    <div class="control-group" id="dvApaterno" >
						      ...
						      <div class="controls">
						        <input type="text" class="span6 typeahead" id="txtApaterno"  data-provide="typeahead"  name="txtApaterno"  value="<%= reserva.getAparterno()%>">
						    ...
						    <div class="control-group" id="dvAmaterno" >
						      ...
						      <div class="controls">
						        <input type="text" class="span6 typeahead" id="txtAmaterno"  data-provide="typeahead"  name="txtAmaterno"  value="<%= reserva.getAmaterno()%>">
						    ...
						    <div class="control-group" id="dvNrodoc" >
						      ...
						      <div class="controls">
						        <input type="text" class="span6 typeahead" id="txtNrodoc"  name="txtNrodoc" data-provide="typeahead" data-items="4" value="<%= reserva.getNumerodoc()%>"  >
							...
							<div class="control-group" id="dvFecNacimiento">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge datepicker"  id="fFecNacimiento" name="fFecNacimiento" value="<%=formatear(new Date(reserva.getFechanacimiento().getTime())) %>" readonly="readonly">
			              ...
			              <label class="control-label" for="typeahead6">Fecha Registro (*): </label>
			                <div class="controls">
			                  <input type="text" class="input-xlarge datepicker" id="fFecRegistro" name="fFecRegistro" value="<%=formatear(new Date(reserva.getFecharegistro().getTime())) %>" readonly="readonly">
						    ...
						    <div class="control-group" id="dvCorreo" >
						      ...
						      <div class="controls">
						        <input type="text" class="span6 typeahead" id="txtCorreo"  data-provide="typeahead" data-items="4" name="txtCorreo"  value="<%= reserva.getCorreo()%>">
						    ...
						    <div class="control-group" id="dvTelefonofijo">
						      ...
						      <div class="controls">
						        <input type="text" class="span6 typeahead" id="txtTelefonofijo"  data-provide="typeahead" data-items="4" name="txtTelefonofijo"  value="<%= reserva.getTelefonofijo()%>">
						    ...
						    <div class="control-group" id="dvTelefonocelular">
						      ...
						      <div class="controls">
						        <input type="text" class="span6 typeahead" id="txtTelefonocelular"  data-provide="typeahead"  data-items="4" name="txtTelefonocelular"  value="<%= reserva.getTelefonomovil()%>">
