		...
		<div class="row-fluid">
		  ...
		  <noscript>
			...
			<div id="content" class="span10">
			  ...
			  <div>
			    <ul class="breadcrumb">
			      <li> <a href="#">Home</a> / <a href="#">Mantenimiento de Horario Actividad</a> / Buscar Horario Actividad</li>
		        </ul>
		      </div>
			  <div class="row-fluid sortable">
			    <div class="box span12">
			      <div class="box-header well" data-original-title>
			        <h2><i class="icon-search"></i> BUSCAR HORARIO ACTIVIDAD</h2>
					  	<div class="box-icon">
					...
					<div class="box-content">
                        <table class="table table-striped table-bordered bootstrap-datatable datatable">
                            ...
                            <div align="right">
                                ...
                                <a class="btn btn-primary" href="agregarhorarioactividad.jsp">
						  ...
						  <tbody>
							<tr>
								...
								<td class="center">Actividad 1</td>
								...
								<td class="center">
									...
									<a class="btn btn-info" href="modificarhorarioactividad.jsp">
										<i class="icon-edit icon-white"></i>
										Modificar
									</a>
									<a class="btn btn-danger" href="eliminarhorarioactividad.jsp">
