                ...
                <div id="content" class="span10">
                    ...
                    <div>
                        <ul class="breadcrumb">
                            ...
                            <li>Agregar Infraccion</li>
                        </ul>
                    </div>
                    <div class="row-fluid sortable">
                        <div class="box span12">
                            <div class="box-header well" data-original-title>
                                <h2><i class="icon-plus-sign"></i>AGREGAR INFRACCION</h2>
                            </div>
                            <div class="box-content">
                                <form class="form-horizontal" action="<%= response.encodeURL("SMAInfraccion")%>" name="frmData" method="post">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="control-group" id="dvCodigoSoc">
                                            ...
                                            <div class="controls">
                                                ...
                                                <input type="text" class="span6 typeahead" id="temp"  data-provide="typeahead" name="temp"   value="<%=codigoSocio%>" disabled>
                                                <input type="hidden"  id="txtCodigoSoc"  name="txtCodigoSoc"   value="<%=codigoSocio%>" >
                                        ...
                                        <div class="control-group" id="dvMonto">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="span6 typeahead" id="txtMonto"  data-provide="typeahead"  name="txtMonto" onkeypress="return numerico(event);">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="input-xlarge datepicker" id="fFecInicio" readonly="true" value="01/01/2013"  name="fFecInicio"  onChange="selectIni0();" >
                                                    </div>
                                        </div>
        ...
        <script>
            ...
            function validaForm(){
               ...
               // if(!esValido("Vacantes",form.txtVacantes,"Vacantes",1,1,6)){cadena[i]="Vacantes";i++;}
                if(!esValido("Monto",form.txtMonto,"Monto",1,1,6)){cadena[i]="Monto";i++;}
