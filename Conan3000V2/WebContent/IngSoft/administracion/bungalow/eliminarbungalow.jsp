...
<head>
	...
	<script>
		function alt_submit_eliminar() {
			...
			var r = confirm("¿Esta seguro que desea eliminar este bungalow?");
			if (r == true) {
				if(<%=bungalow.getFlag()%>==1){
        			crearAlert2("No se puede eliminar el bungalow. Se está violando el principio de dependencia.");
        		}else{
					form.submit();    
        		}
			}
              ...
              <div class="row-fluid sortable">
                <div class="box span12">
                  <div class="box-header well" data-original-title>
                    <h2>ELIMINAR BUNGALOW</h2>
                  </div>
                  <div class="box-content">
                  	  <form class="form-horizontal" name="frmDelete" action="<%= response.encodeURL("SMABungalow")%>" method="post">
                      ...
                      <fieldset>
                        <div class="control-group">
                          <label class="control-label" for="disabledInput">N&uacute;mero:</label>
                          <div class="controls">
                            <input class="input-xlarge disabled" id="txtNumero" type="text" name="txtNumero" value="<%=bungalow.getNumero()%>" disabled="">
                          </div>
                        </div>
                        <div class="control-group">
                          <label class="control-label" for="disabledInput">N&uacute;m. de Divisiones:</label>
                          <div class="controls">
                            <input class="input-xlarge disabled" id="txtNumeroDivisiones" type="text" name="txtNumeroDivisiones" value="<%=bungalow.getNumeroDivisiones()%>" disabled="">
                          </div>
                        </div>
                        <div class="control-group">
                          <label class="control-label" for="disabledInput">&Aacute;rea del Bungalow:</label>
                          <div class="controls">
                            <input class="input-xlarge disabled" id="txtAreaBungalow" type="text" name="txtAreaBungalow" value="<%=bungalow.getAreaBungalow()%>" disabled="">
                          </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                          ...
                          <div class="controls">
                            <textarea name="txtDescripcion" rows="3" id="txtDescripcion" disabled="" style="resize:none"><%=bungalow.getDescripcion()%></textarea>
                          </div>
                        </div>
                        <div class="control-group">
								...
								<div class="controls">
								  <label class="radio">
									<input type="radio" disabled="disabled" name="optionsRadios" id="optionsRadios1" value="option1" <%=Estado_Activo(bungalow.getEstado())?"checked":""%>>
									Activo
								  </label>
								  <div style="clear:both"></div>
								  <label class="radio">
									<input type="radio" disabled="disabled" name="optionsRadios" id="optionsRadios2" value="option2" <%=Estado_Inactivo(bungalow.getEstado())?"checked":""%>>
									Inactivo
								  </label>
								</div>
							  </div>
