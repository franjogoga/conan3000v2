...
<head>
	...
	-->
	<meta charset="utf-8">
	<title>Consultar Invitado</title>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
					  <h2><i class="icon-plus-sign"></i>CONSULTAR INVITADO</h2>
				  </div>
					<div class="box-content">
						
						<form class="form-horizontal" action="<%= response.encodeURL("SMAInvitado")%>" name="frmData" method="post">
