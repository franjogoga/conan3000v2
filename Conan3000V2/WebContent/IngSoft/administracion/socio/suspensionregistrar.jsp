		...
		<div class="row-fluid">
		  ...
		  <noscript>
			...
			<div id="content" class="span10">
			  ...
			  <div>
			    <ul class="breadcrumb">
			      <li> <a href="#">Home</a> / <a href="#">Mantenimiento de Socios</a> / Registrar Suspensi&oacuten</li>
		        </ul>
		      </div>
			  <div class="row-fluid sortable">
			    <div class="box span12">
			      <div class="box-header well" data-original-title>
			        <h2>REGISTRAR SUSPENSION</h2>
					</div>
						...
						<form class="form-horizontal">
						  <fieldset>
                              ...
                              <div class="control-group">
                                  ...
                                  <label class="control-label" for="typeahead7">C&oacutedigo de Familiar: </label>
                                  <div class="controls">
                                      <input type="text" class="span6 typeahead" id="typeahead7"  data-provide="typeahead" >
                                          </div>
                              </div>
							  ...
							  <div class="control-group">
                                  ...
                                  <label class="control-label" for="typeahead7">Nombre de Familiar(*): </label>
                                  <div class="controls">
                                      <input type="text" class="span6 typeahead" id="typeahead7"  data-provide="typeahead" >
                                          </div>
                              </div>
                              ...
                              <div class="control-group">
			              <label class="control-label" for="typeahead7">Fecha de Susp.(*): </label>
			              <div class="controls">
			                <input type="text" class="input-xlarge datepicker" id="date01" value="02/16/2012">
							   ...
							   <div class="control-group">
                                  <label class="control-label" for="selectError">Tipo de Falta(*):</label>
                                  <div class="controls">
                                      <select name="selectError" id="selectError2" data-rel="chosen">
                                          <option> D&iacuteas </option>
                                          <option> Meses </option>
                                          <option> Años </option>                                      
                                        </select>
                                  </div>
                               ...
                               <div class="control-group">
                                  ...
                                  <label class="control-label" for="typeahead7">Cantidad de Susp.(*): </label>
                                  <div class="controls">
                                      <input type="text" class="span6 typeahead" id="typeahead7"  data-provide="typeahead" >
                                          </div>
                              </div>
