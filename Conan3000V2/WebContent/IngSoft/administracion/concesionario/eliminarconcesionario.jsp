                    ...
                    <form class="form-horizontal">
                      <fieldset>
                        <div class="control-group">
                          <label class="control-label" for="disabledInput">Raz&oacuten Social:</label>
                          <div class="controls">
                            <input class="input-xlarge disabled" id="disabledInput" type="text" placeholder="Pizzas Saul" disabled="">
                          </div>
                        </div>
                        <div class="control-group">
                          <label class="control-label" for="disabledInput">RUC:</label>
                          <div class="controls">
                            <input class="input-xlarge disabled" id="disabledInput1" type="text" placeholder="00912947361" disabled="">
                          </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                          ...
                          <div class="controls">
                            <input type="text" class="input-xlarge datepicker" id="date01" value="02/16/2009" disabled="">
                          </div>
                        </div>
                        <div class="control-group">
                          <label class="control-label" for="date01">Fecha final de concesi&oacuten:</label>
                          <div class="controls">
                            <input type="text" class="input-xlarge datepicker" id="date02" value="02/16/2014" disabled="">
                          </div>
                        </div>
                        <div class="control-group">
                  		  <label class="control-label" for="textarea2">Descripci&oacuten:</label>
                          <div class="controls">
                            <textarea name="textarea" rows="3" id="textarea2" disabled="" style="resize:none" placeholder="Pastas y pizzas."></textarea>
                          </div>
                        </div>
