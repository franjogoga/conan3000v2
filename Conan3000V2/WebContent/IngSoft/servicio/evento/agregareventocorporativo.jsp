						  ...
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls" id="listainvitados">
									...
									<input id="appendedInputButton" size="16" type="text" id="txtDNIinvitado" value="DNI"/><input id="appendedInputButton" size="16" type="text" value="Nombre"/><input id="appendedInputButton" size="16" type="text" value="Apellido Paterno"/><input id="appendedInputButton" size="16" type="text" value="Apellido Materno"/>
								  	<br/>
								  	</div>
							</div>	
							<div class="form-actions">
							  <button type="button" id="btnAgregarFila" class="btn btn-primary" onclick="agregarfilar()">Agregar Filas</button><input type="text" class="span1 typeahead" id="txtAgregarFilas" name="txtAgregarFilas" value="0" onkeypress="return numerico(event);" autofocus maxlength="3"/>							 
							</div>													
						    <div class="form-actions">
