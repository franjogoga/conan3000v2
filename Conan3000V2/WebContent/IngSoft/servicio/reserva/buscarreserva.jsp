...
<head>
	<!--
	Formulario para la generaci�n de las reservas de las actividades.
	-->
	<meta charset="utf-8">
...
<script type="text/javascript">
    ...
    function cambiarTabla(){
        ...
        var div = document.getElementById("tablaCanchaFutbol").value;
...
<footer>
			<p class="pull-left">&copy; <a href="http://usman.it" target="_blank">Las 2 vírgenes</a> 2013</p>
			<p class="pull-right">Powered by: <a href="http://usman.it/free-responsive-admin-template">Las dos Vírgenes</a></p>
		</footer>
