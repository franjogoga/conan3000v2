...
<button class="btn"><i class="icon-chevron-left"></i>Anterior</button><button class="btn">Actual</button><button class="btn">Siguiente<i class="icon-chevron-right"></i></button>
</div>
