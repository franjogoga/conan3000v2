...
<body>
		...
		<div class="row-fluid">
		  ...
		  <div id="content" class="span10">
		    ...
		    <div>
		      <ul class="breadcrumb">
		        <li> <a href="#">Home</a> / Generar Reportes</li>
	          </ul>
	        </div>
		          ...
		          <form class="form-horizontal">
		            <fieldset>
		              <div class="control-group">
								<label class="control-label" for="selectError">Seleccioner Reporte:</label>
								<div class="controls">
		              ...
		              <div class="control-group">
		                ...
		                <div class="control-group">
								<label class="control-label" for="selectError6">Producto:</label>
								<div class="controls">
		                ...
		                <div class="control-group">
		                  <label class="control-label" for="appendedPrependedInput">Monto:</label>
		                  <div class="controls">
		                    <div class="input-prepend input-append"> <span class="add-on">$</span>
		                      <input id="appendedPrependedInput" size="16" type="text">
		                      <span class="add-on">.00</span> &nbsp;&nbsp; hasta &nbsp;&nbsp; <span class="add-on"> $</span>
		                      <input id="appendedPrependedInput" size="16" type="text">
