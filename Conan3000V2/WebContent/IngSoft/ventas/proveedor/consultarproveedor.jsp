		...
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="buscarproveedor.jsp">Mantenimiento de Proveedores</a> <span class="divider">/</span>
					</li>
					<li>
						Consultar de Proveedor
					</li>
				</ul>
			</div>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
					  <h2><i class="icon-plus-sign"></i>CONSULTAR PROVEEDOR</h2>
				  </div>
					<div class="box-content">
						<form class="form-horizontal" action="<%= response.encodeURL("SMVProveedor")%>" name="frmData" method="POST">
		                  ...
		                  <div class="controls">
						    ...
						    <div class="form-actions" >
							 <!--  <button type="submit" class="btn btn-primary">Agregar</button> -->
							  <button type="button" class="btn" onclick="location.href='buscarproveedor.jsp'" >Regresar</button>
							</div>
						  </fieldset>
					  </form>   
