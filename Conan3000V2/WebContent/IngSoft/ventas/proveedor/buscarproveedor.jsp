		          ...
		          <table class="table table-striped table-bordered bootstrap-datatable datatable">
		            ...
		            <tbody>
		              <tr>
		                ...
		                <td class="center"><a class="btn btn-success" href="#"> <i class="icon-zoom-in icon-white"></i> Ver </a> <a class="btn btn-info" href="modificarproveedor.jsp"> <i class="icon-edit icon-white"></i> Modificar </a> <a class="btn btn-danger" href="eliminarproveedor.jsp"> <i class="icon-trash icon-white"></i> Eliminar </a></td>
	                  </tr>
		              <tr>
		                <td>BACKUS</td>
