		...
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="buscarpromocion.jsp">Mantenimiento de Promociones</a> <span class="divider">/</span>
					</li>
					<li>
						Consultar de Promocion
					</li>
				</ul>
			</div>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
					  <h2><i class="icon-plus-sign"></i>CONSULTAR PROMOCION</h2>
				  </div>
					<div class="box-content">
						<form class="form-horizontal" action="<%= response.encodeURL("SMVPromocion")%>" name="frmData" method="POST">
						<input type="hidden" name="accion" value="Consultar"></input>
						<input type="hidden" name="tipo" value="2"></input>
						
						  <fieldset>
						    <div class="control-group">
						      <label class="control-label" for="typeahead7">Nombre de Promocion(*): </label>
						      <div class="controls">
						        <input type="text" class="span6 typeahead" id="txtNombrePromocion"  data-provide="typeahead"  name="txtNombrePromocion" disabled value="<%=promocion.getNombre()%>">
					          </div>
					        </div>
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge datepicker" id="fFechInicio" name="fFechInicio" value="<%=formatear(new Date(promocion.getFechaInicio().getTime())) %>"   onchange="alt_fecha(this)" disabled>
							  </div>
							</div>
