		...
		<div class="container-fluid">
			<div class="row-fluid">
				...
				<div id="content" class="span10">
				    <!-- content starts -->
				   <jsp:include page="includes/agregarfamiliar.jsp" />
				    <!-- content ends -->
				</div>
			 </div>
		<hr>
...
function validaForm(){
	...
	*/
	...
	if(!esValido("Correo Electronico",form.txtCorreo,"Correo",9,1,50)){cadena[i]="Correo Electronico";i++;}
...
*/
	...
	document.getElementById("errTelefonoF").style.display='none';
	document.getElementById("errTelefonoC").style.display='none';
