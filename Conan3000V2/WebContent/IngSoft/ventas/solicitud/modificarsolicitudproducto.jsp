			  ...
			  <div class="row-fluid sortable">
			    <div class="box span12">
			      <div class="box-header well" data-original-title>
			        <h2><i class="icon-plus-sign"></i>MODIFICAR SOLICITUD PRODUCTOS</h2>
		          </div>
			        ...
			        <form class="form-horizontal">
			          <fieldset>
			             <div class="control-group">
			              ...
			              <div class="control-group">
			                <label disabled class="control-label" for="typeahead6">Precio Unitario:</label>
			                <div class="controls">
		                  ...
		                  <div class="control-group">
							  <label disabled class="control-label" for="date01">Fecha:</label>
							  <div class="controls">
			              ...
			              <div class="control-group">
			                <label disabled class="control-label" for="typeahead8">Monto:</label>
			                <div class="controls">
