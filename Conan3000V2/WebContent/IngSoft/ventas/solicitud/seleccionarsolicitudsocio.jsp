		                	...
		                	<td class="center"><span class="label label-success">
                               ...
                               <td class="center">
                          				<a class="btn btn-success"
                          					href="javascript:alt_Insertar('<%=((ResultadoSolicitudSocioBeanData)resultados.get(i)).getCodSolicitudSocio()%>','<%= ((ResultadoSolicitudSocioBeanData)resultados.get(i)).getNombres() %>','<%= ((ResultadoSolicitudSocioBeanData)resultados.get(i)).getApellidoPaterno()%>','<%= ((ResultadoSolicitudSocioBeanData)resultados.get(i)).getApellidoMaterno()%>','<%= ((ResultadoSolicitudSocioBeanData)resultados.get(i)).getDireccion()%>','<%=df.format(((ResultadoSolicitudSocioBeanData)resultados.get(i)).getFechaNacimiento())%>')">
                          					<i class="icon-ok icon-white"></i>Seleccionar
                          				</a>
								</td>
