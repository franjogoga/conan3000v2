		...
		<div class="row-fluid">
		  ...
		  <noscript>
			...
			<div id="content" class="span10">
			  ...
			  <div>
			    <ul class="breadcrumb">
			      <li> <a href="#">Home</a> / <a href="#">Solicitud de Productos </a> / Eliminar Solicitud de Productos</li>
		        </ul>
		      </div>
			        ...
			        <form class="form-horizontal">
			          <fieldset>
			             <div class="control-group">
			                ...
			                <div class="controls">
			                  <input type="text" disabled class="span6 typeahead" id="typeahead9"  data-provide="typeahead" data-items="4" >
			              ...
			              <div class="control-group">
			                ...
			                <div class="controls">
			                  <input type="text" disabled class="span6 typeahead" id="typeahead6"  data-provide="typeahead" data-items="4" >
		                    </div>
		                  </div>
			              <div class="control-group">
			                <label class="control-label" for="typeahead4">Cantidad:</label>
			                <div class="controls">
			                  <input type="text" disabled class="span6 typeahead" id="typeahead4"  data-provide="typeahead" data-items="4" >
		                    </div>
		                  </div>
