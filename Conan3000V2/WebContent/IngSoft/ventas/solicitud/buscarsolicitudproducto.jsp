...
<body>
		...
		<div class="container-fluid">
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-search"></i>  BUSCAR SOLICITUD PRODUCTO				  </h2>
                        <div class="box-icon">
			...
			<form id="frmAlternativo" name="frmAlternativo" method="POST" action="SMVSolicitudProducto">
					...
					<div class="box-content">
                        ...
                        <div  align="right">
						  ...
						  <%SimpleDateFormat df= new SimpleDateFormat("dd/MM/YYYY"); 
					        ...
					        <td class="center">
                          				<%=
                          					((ResultadoSolicitudProductoBeanData)resultados.get(i)).getIdSolicitudProducto()
                          	 ...
                          	 <td class="center">
                          				<%=
                          					((ResultadoSolicitudProductoBeanData)resultados.get(i)).getEstado()
                               ...
                               <td class="center">
                          				<a class="btn btn-success"
                          					href="javascript:alt_aceptar('<%=((ResultadoSolicitudProductoBeanData)resultados.get(i)).getIdSolicitudProducto()%>')">
                          					<i
...
Aceptar
                          				...
                          				<a class="btn btn-danger"
                          					href="javascript:alt_denegar('<%=((ResultadoSolicitudProductoBeanData)resultados.get(i)).getIdSolicitudProducto()%>')">
