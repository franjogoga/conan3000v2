<!-- content starts -->
			  <div>
		        ...
		        <li> <a href="buscarsolicitud.jsp">Solicitud PMOE</a> <span class="divider">/</span></li>
		        <li> Responder Solicitud PMOE </li>
		        </ul>
		      </div>
			  <div class="row-fluid sortable">
			    <div class="box span12">
			      <div class="box-header well" data-original-title>
			        <h2>RESPONDER SOLICITUD PMOE</h2>
		          </div>
			        ...
			        <form class="form-horizontal">
			          <fieldset>
			            <div class="control-group">
			              ...
			              <div class="controls">
			                <input type="text" class="span6 typeahead" id="typeahead8"  data-provide="typeahead" data-items="4" value="Juan Perez" disabled="" >
                        ...
                        <div class="control-group">
                          ...
                          <div class="controls">
                            <input type="text" class="input-xlarge datepicker" id="date" value="02/16/2012" disabled="">
                          </div>
                        </div>
<div class="control-group">
          <div class="control-group">
			                ...
			                <div class="controls">
			                  <input type="text" class="span6 typeahead" id="typeahead4"  data-provide="typeahead" data-items="4" disabled="">
			                </div>
		                  </div>
			            </div>
			            <div class="control-group">
			              <div class="control-group">
			                ...
			                <div class="controls">
			                 <textarea  id="textarea2" rows="3"  style="resize:none" disabled=""></textarea>
		                    </div>
		                  </div>
			            </div>
			            <div class="control-group">
			              <div class="control-group">
			                <label class="control-label" for="typeahead4">Respuesta: </label>
			                <div class="controls">
