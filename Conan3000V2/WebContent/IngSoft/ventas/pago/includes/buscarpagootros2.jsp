...
<script>
	...
	function alt_buscarCuota2(){
		var form=document.getElementById("frmCriteriosBusqueda");
		form.accion.value="BuscarOrdenPago2";
	...
	function cambioCuota(){
	var form=document.getElementById("frmCriteriosBusqueda");
	
		if(form.cmbConcepto.value=="CUOTAEXTRAORDINARIA"){
			document.getElementById("dvReferencia").style.display='block';
			
		}else{
			document.getElementById("dvReferencia").style.display='none';
		}
...
<!-- content starts -->
		              ...
		              <div class="control-group" id="dvSocio">
		               ...
		               <div class="control-group">
			              ...
			              <div class="controls">
								  ...
								  <select id="cmbConcepto" name="cmbConcepto" data-rel="chosen" onChange="cambioCuota()">
	                  ...
	                  <div class="control-group" id="dvEstado">
		                ...
		                <div class="controls">
		                  <label class="radio">
							...
							<label class="radio" id="dvReferencia">
									<input type="radio" name="rButton" id="optionsRadios3" value="Referencia" onChange="alt_buscarCuota2();">
									Referenciado (Aplicado a todos)
							</label>
	                    </div>
	                  </div>
	                  
		              <div class="form-actions" style="width:900px">
		           ...
		           <br><thead>
		            ...
		            <tbody>
		              ...
		              <tr>
		                ...
		                <td class="center"><span class="label label-<% if(((ResultadoOrdenPagoBeanData)resultados.get(i)).getEstado().equals("Cancelado")){ %>success<% }else{ if(((ResultadoOrdenPagoBeanData)resultados.get(i)).getEstado().equals("No Cancelado")){%>warning<% }else{%>important<% } } %>">
		                <%=
		    ...
		    <!--/row-->
		    <!-- content ends -->
		    <script>verificar();cambioCuota();</script>