<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="/Conan3000V2/IngSoft/administracion/invitado/buscarinvitado.jsp"><i class="icon-wrench"></i><span class="hidden-tablet"> Invitados</span></a></li>
