<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="ajax-link administracion" href="<%=request.getContextPath()%>/IngSoft/administracion/reserva/buscarreserva.jsp"style="display:none"><i class="icon-wrench"></i><span class="hidden-tablet"> Reserva de Invitados</span></a></li>
