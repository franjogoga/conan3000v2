   							...
   							while (i<casosDeUso.size()){
   								...
   								if (mant.equals("ADMINISTRACION")){ 
   										...
   										while ( ((PerfilBeanData)casosDeUso.get(i)).getMantenimiento().equals("VENTA") ){
	   										...
	   										}else if (casoUso.equals("SMVSolicitudProducto")) {%><li><a class="ajax-link venta" href="<%=request.getContextPath()%>/IngSoft/servicio/solicitud/buscarsolicitudproducto.jsp"style="display:none"><i class="icon-wrench"></i><span class="hidden-tablet"> solicitud producto</span></a></li><%	   										
	   										} 
	   										i++;
	   										if (i==casosDeUso.size()) break;
	   									}
