...
public class AccionBuscarReserva extends CoAccion {
	...
	public void ejecutar(ServletContext sc, HttpServletRequest request,
		...
		if(tipo==1)	{//ingresar
			this.direccionar(sc, request, response, "/Club/servicio/reserva/buscarreserva.jsp");
		...
		if(tipo==2){//buscar
			...
			if("bungalow".equals(request.getParameter("cmbServicios"))){			
				...
				sesion.setAttribute("listareservas",null);
				this.direccionar(sc, request, response, "/Club/servicio/reserva/reservaxdia.jsp");}		
			else {
				...
				sesion.setAttribute("reservas",reservas);
				sesion.setAttribute("listareservas",null);
				this.direccionar(sc, request, response, "/Club/servicio/reserva/reservaxhora.jsp");
			}
