...
public class JornadaBeanFuncion {
	...
	public JornadaBeanData crearJornada(HttpServletRequest request, HttpServletResponse response){
		...
		public boolean agregarJornada(JornadaBeanData jornadaData) throws CoException {
			...
			try{
				...
				else jornadaData.setIdJornada("PSO000001");
			...
			{sqlsesion.rollback();
			a.printStackTrace();
				throw CoException.set("Error: Nombre de sorteo repetido", "SMAJornada?accion=Agregar&tipo=1");
