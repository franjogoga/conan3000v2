...
public class AccionAgregarInvitado extends CoAccion {
	...
	public void ejecutar(ServletContext sc, HttpServletRequest request,
		...
		InvitadoBeanData invitadoData=invitadoFuncion.crearInvitado(request, response);
		invitadoFuncion.agregarInvitado(invitadoData);
		...
		this.direccionar(sc, request, response, "/IngSoft/administracion/invitado/agregarinvitado.jsp");
		}
