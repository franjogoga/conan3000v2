		...
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="buscarsorteo.jsp">Inscripcion de Sorteos</a> <span class="divider">/</span>
					</li>
					<li>
						Inscripcion de Sorteos
					</li>
				</ul>
			</div>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
					  <h2><i class="icon-plus-sign"></i>INSCRIPCION SORTEO</h2>
				  </div>
						...
						<input type="hidden" name="tipo" value="2"></input>
						  ...
						  <div class="control-group">
						    ...
						    <div class="control-group">
						      ...
						      <div class="controls">
						        <input type="text" class="span6 typeahead" readonly="true"  data-provide="typeahead" id="txtNombreSorteo" name="txtNombreSorteo" value="<%=sorteo.getDescripcion()%>" onkeypress="return alfanumerico(event);" autofocus>
					          </div>
					        </div>
		                  ...
		                  <div class="control-group">
						      ...
						      <div class="controls">
								<input type="text" class="input-xlarge datepicker" id="fFecSorteo"  readonly="true" value="<%=formatear(new Date(sorteo.getFechaSorteo().getTime())) %>"  name="fFecSorteo" onchange="alt_fecha(this)" disabled>
					          </div>
					        </div>	
