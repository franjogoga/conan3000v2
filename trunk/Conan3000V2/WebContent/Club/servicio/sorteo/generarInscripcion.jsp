<!DOCTYPE html>
<%@page import="IngSoft.servicio.bean.InscripcionBeanData"%>
...
<head>
	...
	<!--The beans  -->
	<jsp:useBean id="sorteo" scope="request"class="IngSoft.servicio.bean.InscripcionBeanData"></jsp:useBean>
				...
				<div class="box span12">
					...
					<div class="box-content">
						 <div class="control-group">
						      <label class="control-label" for="typeahead7">POR FAVOR APUNTE SU CODIGO DE INSCRIPCION </label>
						      <div class="controls">
						        <input type="text" class="span6 typeahead" readonly="true"  data-provide="typeahead" id="txtCodigoSorteo" name="txtCodigoSorteo" value="<%=sorteo.getCodParticipante()%>" onkeypress="return alfanumerico(event);" autofocus>
					          </div>
					        </div>
