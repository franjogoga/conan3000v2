...
<link rel="stylesheet" href="css/skeleton16.css" type="text/css"/>
...
<div class="rt-grid-8 rt-omega">
                        <div class="rt-block">
<ul class="menu-phone">
<li id="item-213"><span class="separator"><span>Call Us Toll Free</span></span>
</li><li id="item-214"><span class="separator"><span>1 - 800 - 234 56 89</span></span>
</li></ul>            </div>
</div>
						<div class="clear"></div>
					</div>
...
<form action="#" enctype="multipart/form-data" method="post" id="josForm" name="josForm" class="form-validate">
		...
		<div id="k2Container" class="k2AccountPage">
				<h3 class="k2ProfileHeading">Detalles del socio</h3>
			<dl>
				<dt class="key"><label id="namemsg" for="name">Nombres</label></dt>
				<dd><input type="text" name="" id="name" size="40" value="" class="inputbox required" maxlength="50" />
					*</dd>
				<dt class="key"><label id="usernamemsg" for="username">Apellido Paterno</label></dt>
				<dd><input type="text" id="username" name="" size="40" value="" class="inputbox required" maxlength="25" />*</dd>
				<dt class="key"><label id="usernamemsg" for="username">Apellido Materno</label></dt>
				<dd><input type="text" id="username" name="" size="40" value="" class="inputbox required" maxlength="25" />*</dd>
				<dt class="key"><label id="usernamemsg" for="username">Telefono</label></dt>
				<dd><input type="text" id="username" name="" size="40" value="" class="inputbox required" maxlength="25" /></dd>
				<dt class="key"><label id="usernamemsg" for="username">Celular</label></dt>
				<dd><input type="text" id="username" name="" size="40" value="" class="inputbox required" maxlength="25" /></dd>
