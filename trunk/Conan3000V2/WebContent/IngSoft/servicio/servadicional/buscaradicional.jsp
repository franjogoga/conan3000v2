<!DOCTYPE html>
<%@page import="IngSoft.servicio.bean.ServAdicionalBeanData"%>
		...
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						Mantenimiento de Servicios Adicionales
					</li>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-search"></i> BUSCAR SERVICIO ADICIONAL</h2>
						<div class="box-icon">
		 ...
		 return false;"> -->
		<form class="form-horizontal" name="frmCriteriosBusqueda" id="frmCriteriosBusqueda" action="<%= response.encodeURL("SMSServAdcional")%>" method="post" >
		 <input type="hidden" id="accion" name="accion" value="Buscar"></input>
		  <input type="hidden" id="tipo" name="tipo" value="2"></input>
						  <fieldset>
							
							<div class="control-group">
							  <label class="control-label" for="typeahead">Nombre de Servicio Adicional </label>
							  <div class="controls">
			...
			<form id="frmAlternativo" name="frmAlternativo" method="post" action="<%= response.encodeURL("SMSServAdcional")%>">
...
<% SimpleDateFormat df= new SimpleDateFormat("dd/MM/yyyy"); 
                          		...
                          		<tr>
                          			<td class="center">
                          			<%=((ServAdicionalBeanData)resultados.get(i)).getTipo()%>                          			
                          			</td>
                          			<td class="center">
                          				<%=
                          					((ServAdicionalBeanData)resultados.get(i)).getNombre()
                          				%>
                          			</td>
                          			<td class="center">
                          				<%=
                          					((ServAdicionalBeanData)resultados.get(i)).getPrecio()
                          				%>
                          			</td>
                          			<td class="center">
                          				<%=
                          						((ServAdicionalBeanData)resultados.get(i)).getEstado()                 
                          				%>
                          			</td>                          			
