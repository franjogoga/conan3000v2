			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
					  <h2><i class="icon-plus-sign"></i>Agregar Fallida</h2>
				  </div>
					<div class="box-content">
						<div class="box-content">
						      <label class="control-label" for="typeahead7">Agregar Sorteo Fallido</label>
						      <h1>Por favor seleccionar al menos un bungalow</h1>
							  
							 <!--  <button type="submit" class="btn btn-primary">Agregar</button> -->
							  <button type="button" class="btn" onclick="location.href='buscarsorteo.jsp'" >Regresar</button>
