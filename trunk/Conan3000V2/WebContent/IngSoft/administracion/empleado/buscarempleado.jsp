...
<body>
	<jsp:include page="/IngSoft/general/superior.jsp" />
		...
		<div class="row-fluid">
		 ...
		 <!--  paso 1  configuracion de link + variables -->													 <!-- nos linkea al archivo SMAEmpleado -->
		 <form class="form-horizontal" name="frmCriteriosBusqueda" id="frmCriteriosBusqueda"  method="post" action="<%= response.encodeURL("SMAEmpleado")%>">
		                                      <!-- Buscar  variable  que pasa al archivo SMAEmpleado   -->	
		 <input type="hidden" name="accion" value="Buscar"></input>
		  <input type="hidden" name="tipo" value="2"></input>
		    ...
		    <!--  paso 3  configuracion de link + variables -->				  <!-- nos linkea al archivo SMAEmpleado -->
			<form id="frmAlternativo" name="frmAlternativo" method="post" action="<%= response.encodeURL("SMAEmpleado")%>">
