		  ...
		  <div id="content" class="span10">
		    ...
		    <div>
		      <ul class="breadcrumb">
		        ...
		        <li> <a href="#">Mantenimiento de Usuarios</a> <span class="divider">/</span> </li>
		        <li> Busqueda de Usuario </li>
	          </ul>
	        </div>
		            ...
		            <fieldset>
					  ...
					  <div class="control-group">
		                ...
		                <div class="controls">
                          ...
                          <p class="help-block">Escriba sobre la casilla un nombre de usuario para ser autocompletado</p>
		                </div>
	                  <div class="control-group">
                                
                                
                                <label class="control-label" for="typeahead7">C&oacutedigo Empleado: </label>
                                <div class="controls">
                                    <input type="text" class="span6 typeahead" id="typeahead7"  data-provide="typeahead" >
                                        </div>
					        </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
						    ...
						    <div class="control-group">
                                ...
                                <label class="control-label" for="typeahead7">Area: </label>
                                <div class="controls">
                                    <input type="text" class="span6 typeahead" id="typeahead7"  data-provide="typeahead" >
                                        </div>
					        </div>
		      ...
		      <div class="box span12">
		        ...
		        <div class="box-content">
		          <table class="table table-striped table-bordered bootstrap-datatable datatable">
		            <!-- agregar nuevo boton -->
		            <div  align="right"> <a class="btn btn-primary" href="usuarioagregar.jsp"> <i class="icon icon-add icon-white"></i> Agregar </a> </div>
		            <thead>
		              <tr>
		            ...
		            <tbody>
		              <tr>
		                ...
		                <td class="center"><a class="btn btn-success" href="#"> <i class="icon-zoom-in icon-white"></i> Ver </a> <a class="btn btn-info" href="usuariomodificar.jsp"> <i class="icon-edit icon-white"></i> Modificar </a> <a class="btn btn-danger" href="usuarioeliminar.jsp"> <i class="icon-trash icon-white"></i> Eliminar </a></td>
	                  </tr>
