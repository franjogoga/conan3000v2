...
<head>
	...
	-->
	<meta charset="utf-8">
	<title>Consultar Horario de Trabajo</title>
		...
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						Consultar de Horario de Trabajo
					</li>
				</ul>
			</div>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
					  <h2><i class="icon-plus-sign"></i>CONSULTAR HORARIO DE TRABAJO</h2>
				  </div>
...
<!-- -------- -->		
						    ...
						    <div class="form-actions" >
							 <!--  <button type="submit" class="btn btn-primary">Agregar</button> -->
							  <button type="button" class="btn" onclick="location.href='buscarhorariodetrabajo.jsp'" >Regresar</button>
							</div>
