		...
		<div class="row-fluid">
		  ...
		  <noscript>
			...
			<div id="content" class="span10">
			  ...
			  <div>
			    <ul class="breadcrumb">
			      <li> <a href="#">Home</a> /  Generar Reporte Deudores</li>
		        </ul>
		      </div>
			  <div class="row-fluid sortable">
			    <div class="box span12">
			      <div class="box-header well" data-original-title>
					 ...
					 <h2><i class="icon-edit"></i> GENERAR REPORTE DEUDORES </h2>
		          </div>
			      <div class="box-content">
			        <form class="form-horizontal">
					  ...
					  <!--    ----------------------------------------------------------------------------------------------    -->
						    ...
						    <div class="control-group">
                                <label class="control-label" for="typeahead7">Ap. Paterno: </label>
                                <div class="controls">
                                    <input type="text" class="span6 typeahead" id="typeahead7"  data-provide="typeahead" >
                                 </div>
					        </div>
						    <div class="control-group">
                                <label class="control-label" for="typeahead7">Ap. Materno: </label>
                                <div class="controls">
                                    <input type="text" class="span6 typeahead" id="typeahead7"  data-provide="typeahead" >
                                 </div>
					        </div>
