                        ...
                        <div class="control-group" id="dvNombre">
                          ...
                          <div class="controls">
							...
							<div class="control-group" id="dvFecInicio">
							 ...
							 <div class="control-group" id="dvFecFin">
			              <label class="control-label" for="typeahead6">Fecha Fin (*): </label>
			                <div class="controls">
			                  <input type="text" class="input-xlarge datepicker" id="fFecFin" name="fFecFin" value="<%=fecAnoFin%>" readonly="readonly">
			                  <span class="help-inline" id="errFecFin">Please correct the error</span>
			                </div>
		                  </div>
