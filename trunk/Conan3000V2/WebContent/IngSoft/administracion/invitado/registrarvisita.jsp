		...
		<div class="row-fluid">
		  ...
		  <noscript>
			...
			<div id="content" class="span10">
			  ...
			  <div>
			    <ul class="breadcrumb">
			      <li> <a href="#">Home</a> / <a href="#">Mantenimiento de Invitados</a> / Registrar Visitas de Invitados</li>
		        </ul>
		      </div>
			  <div class="row-fluid sortable">
			    <div class="box span12">
			      <div class="box-header well" data-original-title>
			        <h2>REGISTRAR VISITA DE INVITADOS</h2>
					</div>
					<div class="box-content">
						<form class="form-horizontal">
						  <fieldset>
                              ...
                              <div class="control-group">
			              <label class="control-label" for="typeahead7">Fecha Invitaci&oacuten(*): </label>
			              <div class="controls">
			                <input type="text" class="input-xlarge datepicker" id="date01" value="02/16/2012">
							    ...
							    <div class="control-group">
                                  ...
                                  <label class="control-label" for="typeahead7">D&iacuteas Invitaci&oacuten(*): </label>
                                  <div class="controls">
                                      <input type="text" class="span6 typeahead" id="typeahead7"  data-provide="typeahead" >
                                          </div>
                              </div>  
