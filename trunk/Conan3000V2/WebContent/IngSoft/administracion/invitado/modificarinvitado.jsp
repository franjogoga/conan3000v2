			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
					  <h2><i class="icon-edit"></i>MODIFICAR INVITADO</h2>
				  </div>
						...
						<input type="hidden" name="tipo" value="2"></input>
						  ...
						  <fieldset>
							...
							<div class="control-group" id="dvFecNacimiento">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge datepicker"  id="fFecNacimiento" name="fFecNacimiento" value="<%=formatear(new Date(invitado.getFechanacimiento().getTime())) %>" readonly="readonly">
			              ...
			              <label class="control-label" for="typeahead6">Fecha Registro (*): </label>
			                <div class="controls">
			                  <input type="text" class="input-xlarge datepicker" id="fFecRegistro" name="fFecRegistro" value="<%=formatear(new Date(invitado.getFecharegistro().getTime())) %>" readonly="readonly">
							...
							<div class="control-group">
								...
								<div class="controls">
								  ...
								  if( invitado.getEstado().equalsIgnoreCase("Activo") ){
								...
								Activo
								  ...
								  <%
								  if( invitado.getEstado().equalsIgnoreCase("Inactivo") ){
