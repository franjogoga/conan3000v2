						...
						<input type="hidden" name="tipo" value="2"></input>
						  ...
						  <fieldset>
						    ...
						    <div class="control-group" id="dvNrodoc" >
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge datepicker" id="date01" value="<%=formatear(new Date(invitado.getFechanacimiento().getTime())) %>"  name="fFecNacimiento" onchange="alt_fecha(this)" >
							  </div>
							</div>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge datepicker" id="date02" value="<%=formatear(new Date(invitado.getFecharegistro().getTime())) %>" name="fFecRegistro" onchange="alt_fecha(this)" >
							  </div>
							</div>
