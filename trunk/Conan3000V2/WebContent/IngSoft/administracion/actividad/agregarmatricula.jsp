		...
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						Consultar de Horario de Actividad
					</li>
				</ul>
			</div>
					...
					<div class="box-content">
						...
						<input type="hidden" name="tipo" value=""></input>
						  <fieldset>
							...
							<input type="hidden" name="horario" value="2"></input>
							<input type="hidden" name="codigo" value="2"></input>																				
...
<!-- -------- -->		
						    ...
						    <div class="form-actions" >
							 <!--  <button type="submit" class="btn btn-primary">Agregar</button> -->
							  <button type="button" class="btn" onclick="location.href='buscarhorariodeactividad.jsp'" >Regresar</button>
							</div>
