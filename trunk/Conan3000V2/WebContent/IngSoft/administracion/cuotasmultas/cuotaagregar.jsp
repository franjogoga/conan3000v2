		...
		<div class="row-fluid">
		  ...
		  <noscript>
			...
			<div id="content" class="span10">
			  ...
			  <div>
			    <ul class="breadcrumb">
			      <li> <a href="#">Home</a> / <a href="#">Registrar Cuota Extraordinaria</li>
		        </ul>
		      </div>
			    ...
			    <div class="box span12">
			      <div class="box-header well" data-original-title>
					...
					<div class="box-content">
						<form class="form-horizontal">
						  <fieldset>
							  ...
							  <div class="control-group">
                                  ...
                                  <label class="control-label" for="typeahead7">C&oacutedigo de Venta(*): </label>
                                  <div class="controls">
                                      <input type="text" class="span6 typeahead" id="typeahead7"  data-provide="typeahead" >
                                          </div>
                              </div>
                           ...
                           <div class="control-group">
                                  ...
                                  <label class="control-label" for="typeahead7">Nro. de Cuotas(*): </label>
                                  <div class="controls">
                                      <input type="text" class="span6 typeahead" id="typeahead7"  data-provide="typeahead" >
                                          </div>
                              </div>
                          ...
                          <div class="control-group">
                                  ...
                                  <label class="control-label" for="typeahead7">D&iacuteas de Pago(*): </label>
                                  <div class="controls">
                                      <input type="text" class="span6 typeahead" id="typeahead7"  data-provide="typeahead" >
                                          </div>
                              </div>    
						...
						<div class="control-group">
			              <label class="control-label" for="typeahead7">Fecha Inicio de Pago(*): </label>
			              <div class="controls">
			                <input type="text" class="input-xlarge datepicker" id="date01" value="02/16/2012">
		                  </div>
		                </div>							
