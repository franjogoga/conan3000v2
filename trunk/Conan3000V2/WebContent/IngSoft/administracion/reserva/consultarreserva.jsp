			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
					  <h2><i class="icon-plus-sign"></i>CONSULTAR VISITA</h2>
				  </div>
						...
						<input type="hidden" name="tipo" value="2"></input>
						  <fieldset>
						    ...
						    <div class="control-group">
						      <label class="control-label" for="typeahead7">Nombre Invitado: </label>
						      <div class="controls">
						        <input type="text" class="span6 typeahead" id="txtNombre"  data-provide="typeahead"  name="txtNombre" disabled value="<%= reserva.getNombre()%>">
					          </div>
					        </div>
						    ...
						    <div class="control-group">
						      ...
						      <div class="controls">
						        <input type="text" class="span6 typeahead" id="txtNombre"  data-provide="typeahead"  name="txtNombre" disabled value="<%= reserva.getEstado()%>">
					          </div>
					        </div>
