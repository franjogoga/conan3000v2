...
<%@page import="IngSoft.administracion.bean.ResultadoSoBeanData"%>
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <%SimpleDateFormat df= new SimpleDateFormat("dd/MM/YYYY"); 
					        ...
					        <td class="center">
                          				<%=
                          					((ResultadoSoBeanData)resultados.get(i)).getNombre()
                          	 ...
                          	 <td class="center">
                          				<%=
                          					((ResultadoSoBeanData)resultados.get(i)).getApaterno()
                            ...
                            <td class="center">
                          			<%=
                          					((ResultadoSoBeanData)resultados.get(i)).getAmaterno()
                               ...
                               <td class="center">
                          				<a class="btn btn-success"
                          					href="javascript:alt_Insertar('<%=((ResultadoSoBeanData)resultados.get(i)).getCodigo()%>')">
                          					<i
