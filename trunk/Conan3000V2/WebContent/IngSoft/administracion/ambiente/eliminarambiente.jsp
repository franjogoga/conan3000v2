                    ...
                    <form class="form-horizontal">
                      <fieldset>
                        <div class="control-group">
                          ...
                          <div class="controls">
                            <input class="input-xlarge disabled" id="disabledInput" type="text" placeholder="Sala de juegos" disabled="">
                          </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                          ...
                          <div class="controls">
                            <textarea name="textarea" rows="3" id="textarea2" disabled="" style="resize:none" placeholder="Sala con diversos juegos de mesa."></textarea>
                          </div>
                        </div>
                        <div class="control-group">
                          <label class="control-label" for="textarea2">Caracter&iacutesticas: </label>
                          <div class="controls">
                            <textarea name="textarea2" rows="3" id="textarea2" disabled="" style="resize:none" placeholder="Área: 5 metros cuadrados."></textarea>
                          </div>
                        </div>
