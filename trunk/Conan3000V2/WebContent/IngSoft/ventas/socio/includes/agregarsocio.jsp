							...
							<input type="hidden" name="tipo" value="2"></input>
			                  ...
			                  <fieldset>
			                    ...
			                    <div class="control-group" id="dvNombres">
			              		...
			              		<div class="controls">
			               		 <input type="text" class="input-xlarge datepicker" id="fFechaNacimiento" name="fFechaNacimiento" readonly="readonly" onKeyUp="limita(this,10);" onKeyDown="limita(this,10);" onpaste="return false;">
