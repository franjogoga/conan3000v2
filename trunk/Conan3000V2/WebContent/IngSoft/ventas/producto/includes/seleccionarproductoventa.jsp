		            ...
		            <tbody id="resultadobusqueda">
		             <%           
		                ...
		                <a class="btn btn-success"
                          					href="javascript:alt_Insertar('<%=((ResultadoProductoBeanData)resultados.get(i)).getIdProdProveedor()%>','<%= ((ResultadoProductoBeanData)resultados.get(i)).getNombre() %>')">
