		...
		<div class="container-fluid">
			<div class="row-fluid">
				...
				<div id="content" class="span10">
				    <!-- content starts -->
				   <jsp:include page="includes/agregarmembresia.jsp" />
				    <!-- content ends -->
				</div>
			 </div>
		<hr>
...
function validaForm(){
	...
	*/
	...
	if(!esValido("Costo",form.txtCosto,"Costo",1,1,50)){cadena[i]="Costo";i++;}else{
	if(!validaFloat(form.txtCosto)){cadena[i]="Costo";i++;}
	}
	if(!inputRadioLleno(form.rButton)){cadena[i]="Estado";i++;}
