			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-search"></i> FORMULARIO DE MULTAS POR MEMBRESIA			  </h2>
                        <div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" name="frmMulta" id="frmMulta"  method="POST" action="<%= response.encodeURL("SMVPago")%>">
						  ...
						  <fieldset>
						    <div class="control-group">
						     ...
						     <div class="control-group">
							    <label class="control-label" for="typeahead6">Cant. Vencida (Membresias): </label>
							    <div class="controls">
						...
						<div class="control-group" id="dvFechaActual">
                            ...
                            <div class="controls">
                              <input type="text" class="input-xlarge disabled" id="date2" name="fFechaActual" value="<%=fecHoy%>" readonly="true">
