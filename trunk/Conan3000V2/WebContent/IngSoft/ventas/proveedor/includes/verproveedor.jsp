		    ...
		    <div>
		      <ul class="breadcrumb">
		        <li> <a href="#">Home</a> / <a href="buscarproveedor.jsp">Mantenimiento de Proveedores</a> / Ver Proveedor</li>
	          </ul>
	        </div>
		          ...
		          <form class="form-horizontal">
		            <fieldset>
		              ...
		              <div class="form-actions">
			               ...
			               <a  name="btnRegresar" class="btn btn-primary" href="buscarproveedor.jsp">Regresar</a>  
