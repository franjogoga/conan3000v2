   							...
   							while (i<casosDeUso.size()){
   								...
   								if (mant.equals("ADMINISTRACION")){ 
   										...
   										while ( ((PerfilBeanData)casosDeUso.get(i)).getMantenimiento().equals("ADMINISTRACION") ){
	   										...
	   										}else if (casoUso.equals("SMAConfiguracion")){%> <li><a class="ajax-link administracion" href="<%=request.getContextPath()%>/IngSoft/administracion/configuracion/SMAConfiguracion?accion=Consultar"style="display:none"><i class="icon-wrench"></i><span class="hidden-tablet"> Configuracion </span></a></li> <%
	   										}
	   										i++;
   										...
   										while ( ((PerfilBeanData)casosDeUso.get(i)).getMantenimiento().equals("SERVICIO") ){
	   										...
	   										}else if (casoUso.equals("SMSServAdicional")){%><li><a class="ajax-link servicio" href="<%=request.getContextPath()%>/IngSoft/servicio/servadicional/SMSServAdcional?accion=Buscar&tipo=1"style="display:none"><i class="icon-wrench"></i><span class="hidden-tablet">Servicios Adicionales</span></a></li><%
	   										}
	   										i++;
	   										if (i==casosDeUso.size()) break;
	   									}
   										...
   										while ( ((PerfilBeanData)casosDeUso.get(i)).getMantenimiento().equals("VENTA") ){
	   										...
	   										}else if (casoUso.equals("SMVVentaProductos")) {%><li><a class="ajax-link venta" href="<%=request.getContextPath()%>/IngSoft/ventas/ventaproducto/buscarventaproducto.jsp"style="display:none"><i class="icon-wrench"></i><span class="hidden-tablet"> Venta de Productos</span></a></li><%	   										
	   										} 
	   										i++;
	   										if (i==casosDeUso.size()) break;
	   									}
