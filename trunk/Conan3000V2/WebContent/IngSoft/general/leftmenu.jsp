<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="ajax-link administracion" href="<%=request.getContextPath()%>/IngSoft/administracion/empleado/buscarempleado.jsp"style="display:none"><i class="icon-wrench"></i><span class="hidden-tablet"> Empleados</span></a></li>
						...
						<li><a class="ajax-link administracion" href="<%=request.getContextPath()%>/IngSoft/administracion/cuotasmultas/multaagregar.jsp"style="display:none"><i class="icon-wrench"></i><span class="hidden-tablet"> Multas</span></a></li>
