   							...
   							while (i<casosDeUso.size()){
   								...
   								if (mant.equals("ADMINISTRACION")){ 
   										...
   										while ( ((PerfilBeanData)casosDeUso.get(i)).getMantenimiento().equals("VENTA") ){
	   										String casoUso = ((PerfilBeanData)casosDeUso.get(i)).getIdCasoUso();
	   										if (casoUso.equals("SMVJuridica")) {%><li><a class="ajax-link venta" href="<%=request.getContextPath()%>/IngSoft/servicio/juridica/juridicabuscar.jsp"style="display:none"><i class="icon-wrench"></i><span class="hidden-tablet"> Persona Juridica</span></a></li><%
	   										...
	   										}else if (casoUso.equals("SMVTraslado")){%> <li><a class="ajax-link venta" href="<%=request.getContextPath()%>/IngSoft/ventas/familia/buscarfamiliar.jsp"style="display:none"><i class="icon-wrench"></i><span class="hidden-tablet"> Traslado de Membresia</span></a></li> <%
	   										...
	   										}else if (casoUso.equals("SMVSolicitudSocio")){%> <li><a class="ajax-link venta" href="<%=request.getContextPath()%>/IngSoft/ventas/solicitud/agregarsolicitudsocio.jsp"style="display:none"><i class="icon-wrench"></i><span class="hidden-tablet"> Solicitud de Socio</span></a></li> <%
